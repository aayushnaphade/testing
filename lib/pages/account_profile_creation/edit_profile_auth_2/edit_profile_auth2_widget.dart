          ...
          Padding(
            ...
            child: Text(
              FFLocalizations.of(context).getText(
                'lucilc10' /* Adjust the content below to up... */,
              ),
                      ...
                      Padding(
                        ...
                        child: AuthUserStreamWidget(
                          builder: (context) => ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/images/20230203_145410897_iOS.jpg',
                              width: 300.0,
                              height: 200.0,
                              fit: BoxFit.contain,
                            ),
          ...
          Padding(
            ...
            child: AuthUserStreamWidget(
              builder: (context) => FlutterFlowDropDown<String>(
                ...
                options: [
                  FFLocalizations.of(context).getText(
                    'mj032fui' /* Water Supply Engineer */,
                  ),
                  FFLocalizations.of(context).getText(
                    'u8gtjpo1' /* valvemen */,
                  )
