...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'internal_login',
          path: '/internalLogin',
          builder: (context, params) => InternalLoginWidget(),
        ),
        FFRoute(
          name: 'adneewentry',
          path: '/adneewentry',
          requireAuth: true,
          builder: (context, params) => AdneewentryWidget(),
        ),
        FFRoute(
          name: 'adneewentryCopy',
          path: '/adneewentryCopy',
          requireAuth: true,
          builder: (context, params) => AdneewentryCopyWidget(),
        ),
        FFRoute(
          name: 'deletezone',
          path: '/deletezone',
          requireAuth: true,
          builder: (context, params) => DeletezoneWidget(),
        ),
        FFRoute(
          name: 'deletezoneCopy',
          path: '/deletezoneCopy',
          requireAuth: true,
          builder: (context, params) => DeletezoneCopyWidget(),
        ),
        FFRoute(
          name: 'AdminCenter',
          path: '/adminCenter',
          builder: (context, params) => AdminCenterWidget(),
        )
